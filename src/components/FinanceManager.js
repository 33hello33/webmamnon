...
export default function FinanceManager({ activeSubTab, setActiveSubTab, currentUser }) {
   ...
   const [stats, setStats] = useState({
      phieuChi: 0, chiLuong: 0, nhapKho: 0, thuHocPhi: 0, thuBanHang: 0, thuKhac: 0, doanhThuDuKien: 0, tongThongBao: 0
   });
   ...
   const fetchData = useCallback(async () => {
      ...
      setStats({
         ...
         tongThongBao: finalTb.filter(t => !isDeleted(t)).reduce((s, t) => s + pCur(t.tongcong), 0)
      });
            ...
            <div className="fm-stats-grid">
               ...
               <div className="fm-stat-card" onClick={() => handleTabClick('phieuthongbao')} style={{ cursor: 'pointer' }}>
                  ...
                  <div className="fm-stat-info">
                     ...
                     <span className="fm-stat-value text-warning">{fCur(stats.tongThongBao)}</span>
                  </div>
               </div>
            </div>
         </div>
