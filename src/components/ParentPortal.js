...
function ParentPortal({ parentData, setParentData }) {
   ...
   const subscribeToPushNotifications = async () => {
      ...
      try {
         // Nếu đã từ chối thì hướng dẫn bật lại trong Cài đặt thay vì alert bình thường
         if (Notification.permission === 'denied') {
            alert(
               'Thông báo đã bị tắt.\n\n' +
               'Để nhận thông báo từ giáo viên và nhà trường, vui lòng:\n' +
         ...
         if (permission !== 'granted') {
            alert(
               ...
               'Để nhận thông báo từ giáo viên và nhà trường:\n' +
               '• Nhấn "Cho phép" khi trình duyệt hỏi\n' +
               '• Hoặc vào Cài đặt điện thoại → Tìm trình duyệt → Bật Thông báo'
            );
            return;
         }
